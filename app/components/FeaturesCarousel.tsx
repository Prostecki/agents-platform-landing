    ...
    <div className="bg-bg-white border-b border-subtle p-[96px_0_80px] overflow-hidden">
      ...
      >
        ...
        <motion.div variants={cardVariants} className="shrink-0 text-center w-[85vw] sm:w-[320px] lg:w-[340px] snap-center">
          <div className="rounded-[32px] overflow-hidden relative mb-6 h-[340px] lg:h-[400px] bg-[linear-gradient(160deg,#bfcfdf_0%,#8faabf_40%,#6a8ea8_100%)] shadow-xl">
            ...
            {/* Top Badge: Recovery */}
            <div className="absolute top-5 left-5 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-3 py-1 flex items-center gap-2">
            ...
            <div className="absolute bg-bg-white/90 border border-white/10 backdrop-blur-xl rounded-2xl p-4 shadow-[0_12px_24px_rgba(0,0,0,0.3)] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] text-left">
              <div className="text-[10px] text-muted font-mono mb-1">WEEKLY LOAD</div>
              ...
              <div className="text-[11px] text-green-text flex items-center gap-1 font-medium">
                <span>↑ 12%</span>
                <span className="text-muted/60 font-normal">than last week</span>
              </div>
            </div>
        ...
        <motion.div variants={cardVariants} className="shrink-0 text-center w-[85vw] sm:w-[380px] lg:w-[420px] snap-center">
          <div className="rounded-[40px] overflow-hidden relative mb-10 h-[420px] lg:h-[480px] bg-[linear-gradient(160deg,#c0bfd8_0%,#8a89b8_40%,#5c5a90_100%)] shadow-2xl scale-[1.02] lg:scale-105 transition-transform duration-500">
            ...
            <div className="absolute bottom-6 lg:bottom-8 left-1/2 -translate-x-1/2 bg-bg-white/95 border border-white/10 backdrop-blur-2xl rounded-[24px] p-5 w-[260px] lg:w-[300px] shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
              ...
              <div className="grid grid-cols-4 gap-2 mb-4">
                {[12, 10, 8, 8].map((reps, i) => (
                  <div key={i} className={`rounded-lg p-2 text-center transition-colors ${i === 2 ? 'bg-green text-[#0f0f0f]' : 'bg-white/5 text-fg'}`}>
                    <div className="text-[9px] opacity-60 mb-0.5">S{i+1}</div>
        ...
        {/* Card 3: Composition */}
        <motion.div variants={cardVariants} className="shrink-0 text-center w-[85vw] sm:w-[320px] lg:w-[340px] snap-center">
          <div className="rounded-[32px] overflow-hidden relative mb-6 h-[340px] lg:h-[400px] bg-[linear-gradient(160deg,#c5c0b8_0%,#a09890_40%,#7a706a_100%)] shadow-xl">
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/40"></div>
            ...
            <svg className="absolute bottom-0 left-0 right-0 h-32 opacity-30" viewBox="0 0 340 120" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0,100 L40,95 L80,85 L120,88 L160,70 L200,65 L240,55 L280,58 L340,40" fill="none" stroke="var(--purple-graph)" strokeWidth="3" strokeLinecap="round" />
              <path d="M0,100 L40,95 L80,85 L120,88 L160,70 L200,65 L240,55 L280,58 L340,40 V120 H0 Z" fill="var(--purple-graph)" fillOpacity="0.1" />
            </svg>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[220px] flex flex-col gap-3">
              <div className="bg-bg-white/90 border border-white/10 backdrop-blur-xl rounded-2xl p-4 shadow-[0_12px_24px_rgba(0,0,0,0.3)]">
                <div className="text-[9px] text-muted font-mono mb-1">BODY WEIGHT</div>
                <div className="text-xl font-bold text-fg">185.4 <span className="text-xs font-normal text-muted">lbs</span></div>
              </div>
              <div className="bg-bg-white/90 border border-white/10 backdrop-blur-xl rounded-2xl p-4 shadow-[0_12px_24px_rgba(0,0,0,0.3)] translate-x-4">
                <div className="text-[9px] text-muted font-mono mb-1">LEAN MASS</div>
      ...
      <div className="flex justify-center gap-1.5 mt-8">
        ...
        <div className="bg-fg w-5 h-1.5 rounded-sm active"></div>
        <div className="w-1.5 h-1.5 rounded-full bg-subtle"></div>
      </div>
    </div>
  )
