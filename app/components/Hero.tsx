    ...
    <div className="relative grid lg:grid-cols-2 min-h-[620px] border-b border-subtle overflow-x-hidden bg-bg">
      ...
      >
        <motion.div
          ...
          className="inline-flex items-center gap-[7px] bg-green-bg border border-green-border rounded-[20px] py-[5px] px-[14px] mb-7 self-start shadow-[0_2px_10px_rgba(34,197,94,0.1)]"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6, delay: 0.5 }}
          className="cta-row flex flex-col sm:flex-row gap-4 items-stretch sm:items-center"
        >
                ...
                <div className="bg-bg border border-subtle rounded-2xl rounded-bl-sm px-4 pt-3 pb-4 flex-1 flex flex-col gap-2.5 shadow-[0_4px_12px_rgba(0,0,0,0.15)]">
                  ...
                  <p className="text-[13px] leading-relaxed text-fg m-0">
                    <span className="relative inline">
                      ...
                      >
                        Your training coach just told me
                      </motion.span>
                    </span>
