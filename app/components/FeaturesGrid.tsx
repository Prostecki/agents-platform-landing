    ...
    <div className="bg-bg-white border-b border-subtle" id="features">
      <div className="w-full max-w-[var(--max)] mx-auto p-[64px_var(--spacing-pad)] lg:p-[96px_var(--spacing-pad)]">
        ...
        >
          ...
          <h2 className="text-[30px] md:text-[36px] lg:text-[42px] font-bold tracking-[-1px] lg:tracking-[-1.5px] leading-[1.08] mb-8 lg:mb-12">Everything a serious athlete needs.</h2>
        </motion.div>
        <motion.div 
        ...
        >
          <motion.div variants={itemVariants} className="border border-subtle rounded-2xl p-6 md:p-8 lg:p-[32px_36px] transition-shadow hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)]">
