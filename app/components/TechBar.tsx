...
export default function TechBar() {
  return (
    <motion.div 
      ...
      viewport={{ once: true }}
      className="bg-bg-white border-b border-subtle p-[18px_var(--spacing-pad)] flex flex-col md:flex-row items-center justify-center gap-[14px] md:gap-10 text-center"
    >
