      ...
      <div className="w-full max-w-[var(--max)] mx-auto p-[64px_var(--spacing-pad)] lg:p-[96px_var(--spacing-pad)]">
        ...
        >
          ...
          <motion.div variants={stepVariants} className="pb-0">
            <div className="text-[48px] lg:text-[64px] font-bold text-white/7 dark:text-white/7 data-[theme=light]:text-black/7 leading-none mb-5 tracking-[-2px]">3</div>
            <div className="text-[18px] lg:text-[20px] font-bold text-fg mb-2.5">Get advice that makes sense</div>
