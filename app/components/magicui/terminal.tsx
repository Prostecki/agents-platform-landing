...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn(
        "border-subtle bg-bg-white z-0 h-full w-full rounded-xl border",
        className
      )}
    >
      <div className="border-subtle flex flex-col gap-y-2 border-b p-4">
        <div className="flex flex-row gap-x-2">
          <div className="h-2.5 w-2.5 rounded-full bg-red-stop"></div>
          <div className="h-2.5 w-2.5 rounded-full bg-yellow-wait"></div>
          <div className="h-2.5 w-2.5 rounded-full bg-green-go"></div>
        </div>
      </div>
